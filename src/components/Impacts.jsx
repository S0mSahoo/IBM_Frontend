...
const Impacts = () => {
  ...
  return( 
  <div className="bg-img flex flex-col w-[100vw] min-h-[100vh] justify-center items-center bg-gray-200 overflow-x-hidden overflow-y-scroll pt-[100px] pb-10" style={scrollBar}  data-aos='fade-up'>
